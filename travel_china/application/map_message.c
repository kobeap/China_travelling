...
/*B2	 K*/	{N1},{N4,CLEFT|STOPTURN,132,60,300,1},
...
/*P3	 7*/	{N3,DRIGHT|CRIGHT|STOPTURN,180,285,300,1},				//原来是130

/*N3 	 8*/	{S1,NO,-28,280,80,View}, {P3,LEFT_LINE,-1,275,300,UpStage},/*step 300*/ {N10,DRIGHT,85,10,70,DOOR}, {N8,DRIGHT,130,25,70,DOOR}, {N4,CLEFT,180,120,130,1},	
	
/*N4 	 9*/	{B2}, {N3,CRIGHT|LEFT_LINE,0,110,300,Special_node},/*step100*/ {N5,DRIGHT|CRIGHT|RIGHT_LINE,178,140,300,Special_node}, /* 175 116 */{B3,NO,-150,64,70,BLBS},			
	
/*N5 	10*/	{N4,CRIGHT|RIGHT_LINE,0,146,300,Special_node}, {N8,DLEFT|STOPTURN,45,160,70,1}, {N12,AWHITE|STOPTURN|CRIGHT,95,20,70,DOOR},{N6,CLEFT,180,110,300,Special_node},//原来是130	
	
/*N6 	11*/	{N5,CLEFT,0,116,300,Special_node}, {C1,CRIGHT|DRIGHT|STOPTURN,150,200,90,1},{P4,RIGHT_LINE,180,150,300,UpStage}, /*step 100*/{S2,NO,-140,80,85,View},
	
/*P4 	12*/	{N6,CLEFT,0,145,300,Special_node},
